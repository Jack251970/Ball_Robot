...
url = 'http://172.25.106.228'  # TODO: Replace with your own url
...
model = YOLO('yolov9e.pt').to(device)  # TODO: Replace with your own model
...
your_face_encoding = np.load('your_face_encoding.npy').reshape(1, -1)  # TODO: Replace with your own model
